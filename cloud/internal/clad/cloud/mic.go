...
// Full command line: ../victor-clad/tools/message-buffers/emitters/Go_emitter.py -C src -o ../cloud/internal clad/cloud/mic.clad
...
func (s *StreamOpen) Unpack(buf *bytes.Buffer) error {
	...
	if err := binary.Read(buf, binary.LittleEndian, &s.StreamId); err != nil {
		return err
	}
	return nil
}
...
func (s *StreamOpen) Pack(buf *bytes.Buffer) error {
	...
	if err := binary.Write(buf, binary.LittleEndian, s.StreamId); err != nil {
		return err
	}
	return nil
}
...
// STRUCTURE StreamIdentifier
type StreamIdentifier struct {
	StreamId uint32
}

func (s *StreamIdentifier) Size() uint32 {
	var result uint32
	result += 4 // StreamId uint_32
	return result
}

func (s *StreamIdentifier) Unpack(buf *bytes.Buffer) error {
	if err := binary.Read(buf, binary.LittleEndian, &s.StreamId); err != nil {
		return err
	}
	return nil
...
func (s *StreamIdentifier) Pack(buf *bytes.Buffer) error {
	if err := binary.Write(buf, binary.LittleEndian, s.StreamId); err != nil {
		return err
	}
	return nil
...
func (s *StreamIdentifier) String() string {
	return fmt.Sprint("StreamId: {", s.StreamId, "}")
}
...
func (h *Hotword) Unpack(buf *bytes.Buffer) error {
	...
	if err := binary.Read(buf, binary.LittleEndian, &h.StreamId); err != nil {
		return err
	}
	return nil
}
...
func (a *AudioData) Unpack(buf *bytes.Buffer) error {
	...
	if err := binary.Read(buf, binary.LittleEndian, &a.StreamId); err != nil {
		return err
	}
	return nil
}
...
func (a *AudioData) Pack(buf *bytes.Buffer) error {
	...
	if err := binary.Write(buf, binary.LittleEndian, a.StreamId); err != nil {
		return err
	}
	return nil
}
...
// ENUM ResponseAudioEncoding
type ResponseAudioEncoding uint8

const (
	ResponseAudioEncoding_Pcm16Le ResponseAudioEncoding = iota
	ResponseAudioEncoding_Opus
)

// ENUM ResponseAudioErrorType
type ResponseAudioErrorType uint8

const (
	ResponseAudioErrorType_Provider ResponseAudioErrorType = iota
	ResponseAudioErrorType_InvalidFormat
	ResponseAudioErrorType_TooLarge
	ResponseAudioErrorType_Timeout
	ResponseAudioErrorType_Cancelled
	ResponseAudioErrorType_Transport
)

// STRUCTURE ResponseAudioStart
type ResponseAudioStart struct {
	ResponseId       string
	Encoding         ResponseAudioEncoding
	SampleRateHz     uint32
	Channels         uint8
	TotalFrames      uint32
...
func (r *ResponseAudioStart) Size() uint32 {
	var result uint32
	result += 1                         // ResponseId length (uint_8)
	result += uint32(len(r.ResponseId)) // uint_8 array
	result += 1                         // Encoding ResponseAudioEncoding
	result += 4                         // SampleRateHz uint_32
	result += 1                         // Channels uint_8
	result += 4                         // TotalFrames uint_32
	result += 1                         // TotalFramesKnown bool
	result += 4                         // StreamId uint_32
	return result
}

func (r *ResponseAudioStart) Unpack(buf *bytes.Buffer) error {
	var ResponseIdLen uint8
	if err := binary.Read(buf, binary.LittleEndian, &ResponseIdLen); err != nil {
		return err
	}
	r.ResponseId = string(buf.Next(int(ResponseIdLen)))
	if len(r.ResponseId) != int(ResponseIdLen) {
		return errors.New("string byte mismatch")
	}
	if err := binary.Read(buf, binary.LittleEndian, &r.Encoding); err != nil {
		return err
	}
	if err := binary.Read(buf, binary.LittleEndian, &r.SampleRateHz); err != nil {
		return err
	}
	if err := binary.Read(buf, binary.LittleEndian, &r.Channels); err != nil {
		return err
	}
	if err := binary.Read(buf, binary.LittleEndian, &r.TotalFrames); err != nil {
		return err
	}
	if err := binary.Read(buf, binary.LittleEndian, &r.TotalFramesKnown); err != nil {
		return err
	}
	if err := binary.Read(buf, binary.LittleEndian, &r.StreamId); err != nil {
		return err
	}
	return nil
}

func (r *ResponseAudioStart) Pack(buf *bytes.Buffer) error {
	if len(r.ResponseId) > 255 {
		return errors.New("max_length overflow in field ResponseId")
	}
	if err := binary.Write(buf, binary.LittleEndian, uint8(len(r.ResponseId))); err != nil {
		return err
	}
	if _, err := buf.WriteString(r.ResponseId); err != nil {
		return err
	}
	if err := binary.Write(buf, binary.LittleEndian, r.Encoding); err != nil {
		return err
	}
	if err := binary.Write(buf, binary.LittleEndian, r.SampleRateHz); err != nil {
		return err
	}
	if err := binary.Write(buf, binary.LittleEndian, r.Channels); err != nil {
		return err
	}
	if err := binary.Write(buf, binary.LittleEndian, r.TotalFrames); err != nil {
		return err
	}
	if err := binary.Write(buf, binary.LittleEndian, r.TotalFramesKnown); err != nil {
		return err
	}
...
func (r *ResponseAudioStart) String() string {
	return fmt.Sprint("ResponseId: {", r.ResponseId, "} ",
		"Encoding: {", r.Encoding, "} ",
		"SampleRateHz: {", r.SampleRateHz, "} ",
		"Channels: {", r.Channels, "} ",
		"TotalFrames: {", r.TotalFrames, "} ",
		"TotalFramesKnown: {", r.TotalFramesKnown, "} ",
		"StreamId: {", r.StreamId, "}")
}

// STRUCTURE ResponseAudioChunk
type ResponseAudioChunk struct {
	ResponseId     string
...
func (r *ResponseAudioChunk) Size() uint32 {
	var result uint32
	result += 1                         // ResponseId length (uint_8)
	result += uint32(len(r.ResponseId)) // uint_8 array
	result += 4                         // SequenceNumber uint_32
	result += 2                         // Data length (uint_16)
	result += uint32(len(r.Data))       // uint_8 array
	result += 4                         // StreamId uint_32
	return result
}

func (r *ResponseAudioChunk) Unpack(buf *bytes.Buffer) error {
	var ResponseIdLen uint8
	if err := binary.Read(buf, binary.LittleEndian, &ResponseIdLen); err != nil {
		return err
	}
	...
	if err := binary.Read(buf, binary.LittleEndian, &r.SequenceNumber); err != nil {
		return err
	}
	var DataLen uint16
	if err := binary.Read(buf, binary.LittleEndian, &DataLen); err != nil {
...
func (r *ResponseAudioChunk) Pack(buf *bytes.Buffer) error {
	if len(r.ResponseId) > 255 {
		return errors.New("max_length overflow in field ResponseId")
	}
	if err := binary.Write(buf, binary.LittleEndian, uint8(len(r.ResponseId))); err != nil {
	...
	if err := binary.Write(buf, binary.LittleEndian, r.SequenceNumber); err != nil {
		return err
	}
	if len(r.Data) > 65535 {
		return errors.New("max_length overflow in field Data")
	}
	if err := binary.Write(buf, binary.LittleEndian, uint16(len(r.Data))); err != nil {
		return err
	}
...
func (r *ResponseAudioChunk) String() string {
	return fmt.Sprint("ResponseId: {", r.ResponseId, "} ",
...
type ResponseAudioEnd struct {
	ResponseId          string
	FinalSequenceNumber uint32
	StreamId            uint32
}

func (r *ResponseAudioEnd) Size() uint32 {
	var result uint32
	result += 1                         // ResponseId length (uint_8)
	result += uint32(len(r.ResponseId)) // uint_8 array
	result += 4                         // FinalSequenceNumber uint_32
	result += 4                         // StreamId uint_32
	return result
}

func (r *ResponseAudioEnd) Unpack(buf *bytes.Buffer) error {
	var ResponseIdLen uint8
	if err := binary.Read(buf, binary.LittleEndian, &ResponseIdLen); err != nil {
		return err
	}
	...
	if err := binary.Read(buf, binary.LittleEndian, &r.FinalSequenceNumber); err != nil {
		return err
	}
	if err := binary.Read(buf, binary.LittleEndian, &r.StreamId); err != nil {
		return err
...
func (r *ResponseAudioEnd) Pack(buf *bytes.Buffer) error {
	if len(r.ResponseId) > 255 {
		return errors.New("max_length overflow in field ResponseId")
	}
	if err := binary.Write(buf, binary.LittleEndian, uint8(len(r.ResponseId))); err != nil {
	...
	if err := binary.Write(buf, binary.LittleEndian, r.FinalSequenceNumber); err != nil {
		return err
	}
	if err := binary.Write(buf, binary.LittleEndian, r.StreamId); err != nil {
		return err
...
func (r *ResponseAudioEnd) String() string {
	return fmt.Sprint("ResponseId: {", r.ResponseId, "} ",
		"FinalSequenceNumber: {", r.FinalSequenceNumber, "} ",
		"StreamId: {", r.StreamId, "}")
}

// STRUCTURE ResponseAudioError
type ResponseAudioError struct {
	ResponseId string
	Error      ResponseAudioErrorType
	Details    string
	StreamId   uint32
}

func (r *ResponseAudioError) Size() uint32 {
	var result uint32
	result += 1                         // ResponseId length (uint_8)
	result += uint32(len(r.ResponseId)) // uint_8 array
	result += 1                         // Error ResponseAudioErrorType
	result += 1                         // Details length (uint_8)
	result += uint32(len(r.Details))    // uint_8 array
	result += 4                         // StreamId uint_32
	return result
}

func (r *ResponseAudioError) Unpack(buf *bytes.Buffer) error {
	var ResponseIdLen uint8
	if err := binary.Read(buf, binary.LittleEndian, &ResponseIdLen); err != nil {
		return err
	}
	...
	if err := binary.Read(buf, binary.LittleEndian, &r.Error); err != nil {
		return err
	}
	var DetailsLen uint8
	if err := binary.Read(buf, binary.LittleEndian, &DetailsLen); err != nil {
		return err
	}
	r.Details = string(buf.Next(int(DetailsLen)))
	if len(r.Details) != int(DetailsLen) {
		return errors.New("string byte mismatch")
	}
	if err := binary.Read(buf, binary.LittleEndian, &r.StreamId); err != nil {
		return err
...
func (r *ResponseAudioError) Pack(buf *bytes.Buffer) error {
	if len(r.ResponseId) > 255 {
		return errors.New("max_length overflow in field ResponseId")
	}
	if err := binary.Write(buf, binary.LittleEndian, uint8(len(r.ResponseId))); err != nil {
	...
	if err := binary.Write(buf, binary.LittleEndian, r.Error); err != nil {
		return err
	}
	if len(r.Details) > 255 {
		return errors.New("max_length overflow in field Details")
	}
	if err := binary.Write(buf, binary.LittleEndian, uint8(len(r.Details))); err != nil {
		return err
	}
	if _, err := buf.WriteString(r.Details); err != nil {
		return err
	}
	if err := binary.Write(buf, binary.LittleEndian, r.StreamId); err != nil {
		return err
...
func (r *ResponseAudioError) String() string {
	return fmt.Sprint("ResponseId: {", r.ResponseId, "} ",
		"Error: {", r.Error, "} ",
		"Details: {", r.Details, "} ",
		"StreamId: {", r.StreamId, "}")
...
func (i *IntentResult) Unpack(buf *bytes.Buffer) error {
	...
	if err := binary.Read(buf, binary.LittleEndian, &i.StreamId); err != nil {
		return err
	}
	return nil
}
...
func (i *IntentResult) Pack(buf *bytes.Buffer) error {
	...
	if err := binary.Write(buf, binary.LittleEndian, i.StreamId); err != nil {
		return err
	}
	return nil
}
...
const (
	...
	MessageTag_ResponseAudioStart                   // 12
	MessageTag_ResponseAudioChunk                   // 13
	MessageTag_ResponseAudioEnd                     // 14
	MessageTag_ResponseAudioError                   // 15
	MessageTag_CancelStream                         // 16
	MessageTag_StreamClosed                         // 17
...
func (m *Message) unpackStruct(tag MessageTag, buf *bytes.Buffer) (clad.Struct, error) {
	...
	case MessageTag_StreamOpen:
		...
		return &ret, nil
	case MessageTag_ResponseAudioStart:
		var ret ResponseAudioStart
		if err := ret.Unpack(buf); err != nil {
			return nil, err
		}
		return &ret, nil
	case MessageTag_ResponseAudioChunk:
		var ret ResponseAudioChunk
		if err := ret.Unpack(buf); err != nil {
			return nil, err
		}
		return &ret, nil
	case MessageTag_ResponseAudioEnd:
		var ret ResponseAudioEnd
		if err := ret.Unpack(buf); err != nil {
			return nil, err
		}
		return &ret, nil
	case MessageTag_ResponseAudioError:
		var ret ResponseAudioError
		if err := ret.Unpack(buf); err != nil {
			return nil, err
		}
		return &ret, nil
	case MessageTag_CancelStream:
		var ret StreamIdentifier
		if err := ret.Unpack(buf); err != nil {
			return nil, err
		}
		return &ret, nil
	case MessageTag_StreamClosed:
		var ret StreamIdentifier
		if err := ret.Unpack(buf); err != nil {
			return nil, err
		}
...
func (t MessageTag) String() string {
	...
	case MessageTag_ResponseAudioChunk:
		return "ResponseAudioChunk"
	case MessageTag_ResponseAudioEnd:
		return "ResponseAudioEnd"
	case MessageTag_ResponseAudioError:
		return "ResponseAudioError"
	case MessageTag_CancelStream:
		return "CancelStream"
	case MessageTag_StreamClosed:
		return "StreamClosed"
...
func (m *Message) GetAudioDone() *StreamIdentifier {
	if m.tag == nil || *m.tag != MessageTag_AudioDone {
		return nil
	}
	return m.value.(*StreamIdentifier)
}

func (m *Message) SetAudioDone(value *StreamIdentifier) {
	newTag := MessageTag_AudioDone
	m.tag = &newTag
	m.value = value
}

func NewMessageWithAudioDone(value *StreamIdentifier) *Message {
	var ret Message
...
func (m *Message) GetStopSignal() *StreamIdentifier {
...
func (m *Message) SetStopSignal(value *StreamIdentifier) {
	newTag := MessageTag_StopSignal
	m.tag = &newTag
	m.value = value
}

func NewMessageWithStopSignal(value *StreamIdentifier) *Message {
	var ret Message
...
func (m *Message) GetResponseAudioStart() *ResponseAudioStart {
	if m.tag == nil || *m.tag != MessageTag_ResponseAudioStart {
		return nil
	}
	return m.value.(*ResponseAudioStart)
}

func (m *Message) SetResponseAudioStart(value *ResponseAudioStart) {
	newTag := MessageTag_ResponseAudioStart
	m.tag = &newTag
	m.value = value
}

func NewMessageWithResponseAudioStart(value *ResponseAudioStart) *Message {
	var ret Message
	ret.SetResponseAudioStart(value)
	return &ret
}

func (m *Message) GetResponseAudioChunk() *ResponseAudioChunk {
	if m.tag == nil || *m.tag != MessageTag_ResponseAudioChunk {
		return nil
	}
	return m.value.(*ResponseAudioChunk)
}

func (m *Message) SetResponseAudioChunk(value *ResponseAudioChunk) {
	newTag := MessageTag_ResponseAudioChunk
	m.tag = &newTag
	m.value = value
}

func NewMessageWithResponseAudioChunk(value *ResponseAudioChunk) *Message {
	var ret Message
	ret.SetResponseAudioChunk(value)
	return &ret
}

func (m *Message) GetResponseAudioEnd() *ResponseAudioEnd {
	if m.tag == nil || *m.tag != MessageTag_ResponseAudioEnd {
		return nil
	}
	return m.value.(*ResponseAudioEnd)
}

func (m *Message) SetResponseAudioEnd(value *ResponseAudioEnd) {
	newTag := MessageTag_ResponseAudioEnd
	m.tag = &newTag
	m.value = value
}

func NewMessageWithResponseAudioEnd(value *ResponseAudioEnd) *Message {
	var ret Message
	ret.SetResponseAudioEnd(value)
	return &ret
}

func (m *Message) GetResponseAudioError() *ResponseAudioError {
	if m.tag == nil || *m.tag != MessageTag_ResponseAudioError {
		return nil
	}
	return m.value.(*ResponseAudioError)
}

func (m *Message) SetResponseAudioError(value *ResponseAudioError) {
	newTag := MessageTag_ResponseAudioError
	m.tag = &newTag
	m.value = value
}

func NewMessageWithResponseAudioError(value *ResponseAudioError) *Message {
	var ret Message
	ret.SetResponseAudioError(value)
	return &ret
}

func (m *Message) GetCancelStream() *StreamIdentifier {
	if m.tag == nil || *m.tag != MessageTag_CancelStream {
		return nil
	}
	return m.value.(*StreamIdentifier)
}

func (m *Message) SetCancelStream(value *StreamIdentifier) {
	newTag := MessageTag_CancelStream
	m.tag = &newTag
	m.value = value
}

func NewMessageWithCancelStream(value *StreamIdentifier) *Message {
	var ret Message
	ret.SetCancelStream(value)
	return &ret
}

func (m *Message) GetStreamClosed() *StreamIdentifier {
	if m.tag == nil || *m.tag != MessageTag_StreamClosed {
		return nil
	}
	return m.value.(*StreamIdentifier)
}

func (m *Message) SetStreamClosed(value *StreamIdentifier) {
	newTag := MessageTag_StreamClosed
	m.tag = &newTag
	m.value = value
}

func NewMessageWithStreamClosed(value *StreamIdentifier) *Message {
	var ret Message
	ret.SetStreamClosed(value)
	return &ret
}
